...
function formatFloor(
  ...
  if (
    !isNonNegativeNumber(floor) ||
    !isNonNegativeNumber(totalFloors)
  ) {
    return null;
  }
...
export default function RentalDetail() {
  ...
  useEffect(() => {
    ...
    async function loadRental() {
      ...
      if (!rentalId) {
        setError(
          'Rental ID is missing from the URL.'
        );
        setLoading(false);
        return;
      }
      ...
      try {
        ...
        if (
          ...
          throw new Error(
            'Invalid rental response from the API.'
          );
        }
